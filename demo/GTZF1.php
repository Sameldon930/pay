...
<div class="tastesdk-box">
    ...
    <div class="main">
        <div class="typedemo">
            <div class="demo-pc">
                <div class="pay-jd">
                    <form action="GTZF2.php" method="post" autocomplete="off">
                        ...
                        <div class="two-step">
                            ...
                            <ul class="pay-infor">
                                ...
                                <li>支付金额：<strong><input type="input" name="amount" value="100"> <span>元</span></strong></li>
...
<!--                                </li>-->
                                ...
                                <!--</li>-->
                                <li>
                                    <input value="907" name="channel" id="wyzf" type="radio">
                                    <label for="wyzf"><img src="yinlian.png" alt="网银支付"><span>网银支付</span></label>
                                </li>
                                <li>
