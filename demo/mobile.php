...
<div class="w100 navBD12">
    <div class="w1080 nav12">
        <div class="nav12-left">
            <a href="/"><img src="/image/logo2.png" alt=""title=" " style="max-height: 38px;"></a>
        </div>
...
<div class="w1080 PayMethod12 border_radis">
    <div class="row">
        <h2>支付方式：</h2>              <ul>            <label for="zfbwap">            <li class="pay_li pc_dis active " data_power_id="3000000011" data_product_id="3000000001">            <input value="904" checked="checked" name="channel" id="zfbwap" type="radio">                <i class="i1"></i>                <span>支付宝支付</span>            </li></label>
            <label for="wxh5">
            <li class="pay_li pc_dis" data_power_id="3000000021" data_product_id="3000000001">
                <input value="912" name="channel" id="wxh5" type="radio">
                <i class="i2"></i>
                <span>微信支付</span>
            </li>  </label>
...
<!--立即支付-->
<div class="w1080 immediate-pay12 border_radis"  >
