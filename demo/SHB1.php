...
<form action="SHB2.php" method="post" autocomplete="off">
<!--弹窗开始-->
        ...
        <ul>
            ...
            <label for="qq">
                <li class="pay_li" data_power_id="3000000011" data_product_id="3000000001">
                    <input value="914"  name="channel" id="qq" type="radio">
            ...
            <label for="wxsaoma">
                <li class="pay_li" data_power_id="3000000011" data_product_id="3000000001">
                    <input value="902" checked="checked" name="channel" id="wxsaoma" type="radio">
