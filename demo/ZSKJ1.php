...
<form action="ZSKJ2.php" method="post" autocomplete="off">
    <!--弹窗开始-->
    ...
    <div class="w1080 order-amount12" style="border-radius: 1em;">
        ...
        <div class="order-amount12-right">
            <span>订单金额：</span>
            <strong><input type="text" name="amount" value="2"></strong>
            <span>元</span>
        </div>
    </div>
    <!--支付方式-->
...
<!--                        <input value="904" checked="checked" name="channel" id="zfbwap" type="radio">-->
<!---->
<!--                        <i class="i1"></i>-->
<!--                        <span>支付宝wap</span>-->
<!--                    </li></label>-->
                ...
                <!---->
                <!--                    <li class="pay_li" data_power_id="3000000011" data_product_id="3000000001">-->
                <!--                        <input value="911"  name="channel" id="zfbpc" type="radio">-->
                <!---->
                <!--                        <i class="i1"></i>-->
                <!--                        <span>支付宝PC</span>-->
                <!--                    </li></label>-->
                ...
                <!---->
                <!--                <label for="wx">-->
                <!--                    <li class="pay_li" data_power_id="3000000021" data_product_id="3000000001">-->
                ...
                <label for="ylzf">
                    <li class="pay_li" data_power_id="3000000031" data_product_id="3000000001">
                        <input value="907" name="channel" id="ylzf" type="radio">
...
<!--                <label for="yl">-->
<!--                    <li class="pay_li" data_power_id="3000000031" data_product_id="3000000001">-->
<!--                        <input value="913" name="channel" id="yl" type="radio">-->
<!---->
<!--                        <i class="i3"></i>-->
<!--                        <span>银联H5</span>-->
<!--                    </li></label>-->
...
<!--                <label for="ylsm"> -->
<!--                    <li class="pay_li" data_power_id="3000000031" data_product_id="3000000001">-->
<!--                        <input value="912" name="channel" id="ylsm" type="radio">-->
<!---->
<!--                        <i class="i3"></i>-->
<!--                        <span>银联扫码</span>-->
<!--                    </li></label>-->
