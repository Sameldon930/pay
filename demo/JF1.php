...
<form action="JF2.php" method="post" autocomplete="off">
<!--弹窗开始-->
...
<div class="w100 navBD12">
    <div class="w1080 nav12">
        <div class="nav12-left">
            <a href="/"><img src="/image/logo2.png" alt="收银台"title="收银台" style="max-height: 38px;"></a>
...
<!--			</label>-->
			<label for="zfbsj">
                <li class="pay_li" data_power_id="30000000294" data_product_id="30000000904">
                    <input value="904"  name="channel" id="zfbsj" type="radio">
                    <i class="i1"></i>
                    <span>支付宝H5</span>
                </li>
			</label>
...
<!--                <input value="907" name="channel" id="yl" type="radio">-->
<!---->
<!--                <i class="i3"></i>-->
<!--                <span>银联支付</span>-->
<!--            </li></label>-->
