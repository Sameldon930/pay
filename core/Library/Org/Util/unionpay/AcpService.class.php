...
include_once 'LogUtil.class.php';
include_once 'Cert.class.php';
...
class AcpService {
	 ...
	 * @return 是否成功
	 */
	static function validate($params,$mch_id) {
		...
		if($params['signMethod']=='01')
		{
			...
			if($params['version']=='5.0.0'){
				...
				$strCert = CertUtil::verifyAndGetVerifyCert($strCert,$mch_id);
				if($strCert == null){
			...
			$isSuccess = AcpService::validateBySecureKey($params, SDKConfig::getSDKConfig($mch_id)->secureKey);
		} 
		return $isSuccess;
	}
