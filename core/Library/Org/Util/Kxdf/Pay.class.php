...
class pay {
     ...
     * @param type $customerNo
     */
    function queryBalance($data, $md5key, $customerNo) {
        $return_data = $this->serve_data($data, $md5key, $customerNo, 'http://df.yongdongchina.com/checkAccount/queryDfBalance.action');
        return $return_data;
    }
