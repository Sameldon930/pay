...
class SkglController extends UserController
{
    ...
    {
        $paypassword = I("post.paypassword", '', 'string,strip_tags,htmlspecialchars');
        if ($paypassword == "") {
            exit("nullerror");
        } else {
    ...
    public function czcz()
    {
        ...
        $tongdao = I("post.tongdaoname", '', 'string,strip_tags,htmlspecialchars');
        $bankcode = I("post.bankname", '', 'string,strip_tags,htmlspecialchars');
        $paypassword = I("post.paypassword", '', 'string,strip_tags,htmlspecialchars');
