...
class WMpaySJBController extends PayController
{
    private $code = '';
    ...
    public function Pay($array)
    {
       ...
       file_put_contents('./Data/WMAlipay.txt', "【" . date('Y-m-d H:i:s') . "】\r\n返回参数!" . json_encode($reInfo) . "\r\n\r\n", FILE_APPEND);
    ...
    {
        file_put_contents(RUNTIME_PATH . '/Logs/Pay/WMpay_SJB_callback.txt', "【" . date('Y-m-d H:i:s') . "】\r\n" . json_encode($_REQUEST) . "\r\n\r\n", FILE_APPEND);
    ...
    public function notifyurl()
    {
        ...
        if ($sign == $result["sign"]) {
            if ($result['payState'] == "SUCCESS") {
                ...
                $this->EditMoney($result['outTradeNo'], 'WMpaySJB', 0);
                echo "SUCCESS";
                return;
            }
        } else {
