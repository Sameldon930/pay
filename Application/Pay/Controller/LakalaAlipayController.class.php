...
class LakalaAlipayController extends PayController
{
    private $code = '';
    ...
    public function Pay($array)
    {
        ...
        file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\转账下单返回参数0!" . $jsonData . "\r\n\r\n", FILE_APPEND);
        //$reInfo = json_decode($this->post_json_data('http://biu.haohan168.cn/order/api/pay', $jsonData), true);
        $reInfo = json_decode($this->post_json_data('http://biu.haohan168.cn/order/api/pay', $jsonData), true);
        file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\转账下单返回参数1!" . json_encode($reInfo) . "\r\n\r\n", FILE_APPEND);
        if ($reInfo['errCode'] === 0) {
            ...
            file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\url!" . $url . "\r\n\r\n", FILE_APPEND);
...
//            $this->showSuccess("成功",$returnPara);
            ...
            if(strpos($_SERVER['HTTP_USER_AGENT'], 'ReadData')!==false){
                ...
                file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\返回页面参数!" . json_encode($this) . "\r\n\r\n", FILE_APPEND);
    ...
    {
        file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\n-----" . json_encode($_REQUEST) . "\r\n\r\n", FILE_APPEND);
    ...
    function secondCheck(){
        file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\进入二次跳转1111！".$pay_info['attach']. "\r\n\r\n", FILE_APPEND);
        ...
        file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\进入二次跳转！".$pay_info['attach']. "\r\n\r\n", FILE_APPEND);
    ...
    function thirdCheck(){
        ...
        file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\进入3次跳转1111！".$pay_info['attach']. "\r\n\r\n", FILE_APPEND);

        file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\进入3次跳转1111aUserId！".$getData['aUserId']. "\r\n\r\n", FILE_APPEND);
        if ($getData['loginId']!=null){
            ...
            //改
            $getQrUrl= "http://biu.haohan168.cn/lakala/getAlipayOrderNum";
            ...
            //改
            $gmInfo = json_decode($this->post_json_data('http://biu.haohan168.cn/lakala/saveUserId', $jsonData), true);
            file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\进入3次跳转111122233！".$gmInfo. "\r\n\r\n", FILE_APPEND);
            ...
            //file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\---+++-!" . $aiUrl."&checkurl=".urlencode($checkurl)."&callbackUrl=".urlencode($callbackUrl). "\r\n\r\n", FILE_APPEND);

            file_put_contents('./Data/lakalaPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\进入3次跳转1111alipayUserId！".$alipayUserId[1]. "\r\n\r\n", FILE_APPEND);
