...
class TonglianAliSmController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site ."Pay_TonglianAliSm_notifyurl.html"; //异步通知
        ...
        if($rspArray['retcode'] == 'SUCCESS') {
            if($this->validSign($rspArray, $return['signkey'])){
                if($rspArray['trxstatus'] == '0000') {
                    $return['amount']/=100;
                    $this->showQRcode($rspArray['payinfo'], $return, 'alipay');
                } else {
