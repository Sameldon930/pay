...
class WMpayKaiController extends PayController
{
    private $code = '';
    ...
    {
      //file_put_contents('./Data/SWK312.txt', "【" . date('Y-m-d H:i:s') . "】\r\n array!" . json_encode($array) . "\r\n\r\n", FILE_APPEND);
        $orderid = I("request.pay_orderid", '');
        $body = I('request.pay_productname', '');
        $memberid = I('request.pay_memberid', '');
//file_put_contents('./Data/SWK312.txt', "【" . date('Y-m-d H:i:s') . "】\r\n array!" . json_encode(I('request.')) . "\r\n\r\n", FILE_APPEND);
        //创建订单
       ...
       file_put_contents('./Data/WMAlipay_Kai.txt', "【" . date('Y-m-d H:i:s') . "】\r\n固码支付宝返回参数!" . json_encode($reInfo) . "\r\n\r\n", FILE_APPEND);
    ...
    {
        file_put_contents(RUNTIME_PATH . '/Logs/Pay/WMpayKai_callback.txt', "【" . date('Y-m-d H:i:s') . "】\r\n" . json_encode($_REQUEST) . "\r\n\r\n", FILE_APPEND);
    ...
    public function notifyurl()
    {
        ...
        if ($sign == $result["sign"]) {
            if ($result['payState'] == "SUCCESS") {
                ...
                $this->EditMoney($result['outTradeNo'], 'WMpayKai', 0);
                echo "SUCCESS";
                return;
            }
        } else {
