...
class WMpayZQRController extends PayController
{
    private $code = '';
    ...
    public function Pay($array)
    {
       ...
       file_put_contents('./Data/WMAlipay_ZQR.txt', "【" . date('Y-m-d H:i:s') . "】\r\n固码支付宝返回参数!" . json_encode($reInfo) . "\r\n\r\n", FILE_APPEND);
    ...
    {
        file_put_contents(RUNTIME_PATH . '/Logs/Pay/WMpayYAN_callback.txt', "【" . date('Y-m-d H:i:s') . "】\r\n" . json_encode($_REQUEST) . "\r\n\r\n", FILE_APPEND);
    ...
    public function notifyurl()
    {
        ...
        if ($sign == $result["sign"]) {
            if ($result['payState'] == "SUCCESS") {
                ...
                $this->EditMoney($result['outTradeNo'], 'WMpayZQR', 0);
                echo "SUCCESS";
                return;
            }
        } else {
