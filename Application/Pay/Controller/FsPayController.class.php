...
class FsPayController extends PayController
{
    private $code = '';
...
//            );
    ...
    public function check()
    {
        ...
        //file_put_contents('./Data/'.$pay_info['pay_tongdao'].'.txt', "【" . date('Y-m-d H:i:s') . "】\r\修改金额后!" . json_encode($pay_info) . "\r\n\r\n", FILE_APPEND);
        $ctime = $pay_info['pay_applydate'];
        //file_put_contents('./Data/'.$pay_info['pay_tongdao'].'.txt', "【" . date('Y-m-d H:i:s') . "】\r\进入---订单状态-" . $pay_info['pay_status']  . "\r\n\r\n", FILE_APPEND);
        if((time() - $ctime)>300){
