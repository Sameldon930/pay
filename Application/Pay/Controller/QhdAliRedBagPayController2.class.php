...
class QhdAliRedBagPayController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        if ($reInfo['errCode'] === 0) {
            ...
            file_put_contents('./Data/QhdAliRedBagPay.txt', "【" . date('Y-m-d H:i:s') . "】\r\修改金额后!" . json_encode($return) . "\r\n\r\n", FILE_APPEND);
		  ...
		  $aliurl="alipayqr://platformapi/startapp?saId=10000007&qrcode=".urlencode($url);
