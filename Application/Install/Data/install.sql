...
CREATE TABLE `pay_admin`  (
  ...
  `username` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '后台用户名',
  `password` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '后台用户密码',
  `groupid` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '用户组',
  `createtime` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `google_secret_key` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '谷歌令牌密钥',
  `mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '手机号码',
  `session_random` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'session随机字符串',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台管理员表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pay_admin
-- ----------------------------
INSERT INTO `pay_admin` VALUES (1, 'adminroot', '81b5234976a55e5181f24d9eab8fb697', 1, 1544019409, '', '', '42K6138GL8mrzyNV8GOIKSiYu39N6U8D');

-- ----------------------------
-- Table structure for pay_alipay_dispense
-- ----------------------------
DROP TABLE IF EXISTS `pay_alipay_dispense`;
CREATE TABLE `pay_alipay_dispense`  (
  `id` int(255) UNSIGNED NOT NULL AUTO_INCREMENT,
  `cash_sweep_id` int(10) NOT NULL DEFAULT 0 COMMENT '支付宝归集账号id',
  `target_username` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '目标支付宝账号(收款方）',
  `amount` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '下发金额',
  `addtime` int(10) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `username`(`target_username`) USING BTREE,
  INDEX `addtime`(`addtime`) USING BTREE,
  INDEX `cash_sweep_id`(`cash_sweep_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '支付宝归集资金下发表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_apimoney`  (
  ...
  `payapiid` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `pay_area_city`  (
  ...
  `province_code` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '省编码',
  `code` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '城市编号',
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名称',
  PRIMARY KEY (`city_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 430 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '城市表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '省份表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_article`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_attachment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 49 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '附件表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_auth_error_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 544 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限错误日志' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_auth_group`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色（用户类型）表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pay_auth_group
-- ----------------------------
INSERT INTO `pay_auth_group` VALUES (1, '超级管理员', 1, 0, '1,2,3,51,4,57,5,55,56,58,59,6,44,52,53,48,70,54,126,7,8,60,61,62,9,63,64,65,66,10,67,68,69,11,131,12,79,80,81,82,83,84,85,86,87,88,89,90,91,93,94,95,96,97,98,99,100,101,120,13,14,15,92,16,73,76,77,78,121,46,17,132,18,19,71,75,20,72,74,22,127,24,25,26,130,125,155,27,28,108,129,29,102,30,103,106,107,119,21,104,105,109,110,111,128,31,32,33,34,160,161,162,163,164,165,166,167,168,169,170,171,35,36,37,38,133,116,122,42,23,114,115,158,159');
...
INSERT INTO `pay_auth_group` VALUES (3, '财务管理员', 1, 1, '1,5,6,70,65,66,67,68,69,15,92,20,24,25,26,104,116,122,42,23,114,115');
INSERT INTO `pay_auth_group` VALUES (4, '普通商户', 1, 1, '');
INSERT INTO `pay_auth_group` VALUES (5, '普通代理商', 1, 1, '1,2,3,51,4,57,5,55,56,58,59,6,44,52,53,48,70,54,126,7,8,60,61,62,9,63,64,65,66,10,67,68,69,11,131,12,79,80,81,82,83,84,85,86,87,88,89,90,91,93,94,95,96,97,98,99,100,101,120,147,148,149,151,152,13,14,15,92,16,73,76,77,78,121,46,17,132,18,19,71,75,20,72,74,22,127,24,25,26,130,125,155,27,28,108,129,29,102,157,30,103,106,107,119,21,104,105,109,110,111,128,31,32,137,138,139,140,141,142,143,144,145,146,33,34,160,161,162,163,164,165,166,167,168,169,170,171,35,36,37,38,133,116,122,42,153,154,23,114,115,');
...
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户、角色关系表' ROW_FORMAT = Fixed;

-- ----------------------------
-- Records of pay_auth_group_access
-- ----------------------------
INSERT INTO `pay_auth_group_access` VALUES (1, 1);
INSERT INTO `pay_auth_group_access` VALUES (3, 11);
INSERT INTO `pay_auth_group_access` VALUES (5, 1);
INSERT INTO `pay_auth_group_access` VALUES (6, 10);
INSERT INTO `pay_auth_group_access` VALUES (7, 11);
INSERT INTO `pay_auth_group_access` VALUES (8, 1);
INSERT INTO `pay_auth_group_access` VALUES (9, 6);
INSERT INTO `pay_auth_group_access` VALUES (10, 1);
INSERT INTO `pay_auth_group_access` VALUES (12, 14);
INSERT INTO `pay_auth_group_access` VALUES (13, 6);
INSERT INTO `pay_auth_group_access` VALUES (14, 6);
INSERT INTO `pay_auth_group_access` VALUES (15, 6);
INSERT INTO `pay_auth_group_access` VALUES (16, 6);
INSERT INTO `pay_auth_group_access` VALUES (17, 10);
INSERT INTO `pay_auth_group_access` VALUES (18, 11);
INSERT INTO `pay_auth_group_access` VALUES (19, 10);
INSERT INTO `pay_auth_group_access` VALUES (20, 10);
INSERT INTO `pay_auth_group_access` VALUES (21, 5);
...
CREATE TABLE `pay_auth_rule`  (
  ...
  `is_menu` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '1:是主菜单 0否',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 172 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '权限菜单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `pay_auth_rule` VALUES (136, '', 'Order/getAccount', '获取通道子账户', 127, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (135, '', 'Order/setOrderPaid', '设置订单为已支付', 127, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (137, '', 'Channel/account', '子账户', 32, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (138, '', 'Channel/editAccountStatus', '修改子账户状态', 32, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (139, '', 'Channel/addAccount', '添加账户', 32, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (140, '', 'Channel/editAccountControl', '风控', 32, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (141, '', 'Channel/editAccount', '编辑子账户', 32, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (142, '', 'Channel/delAccount', '删除子账户', 32, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (143, '', 'Channel/saveEditAccount', '子账户编辑保存', 32, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (144, '', 'Channel/editControl', '接口供应商风控', 32, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (145, '', 'Channel/editSupplier', '编辑接口供应商', 32, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (146, '', 'Channel/editStatus', '修改接口供应商状态', 32, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (147, '', 'User/getChannelAccount', '指定子账号', 12, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (148, '', 'User/saveChannelAccout', '编辑子账户保存', 12, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (149, '', 'User/changeControl', '编辑子账户轮询规则', 12, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (151, '', 'Transaction/userConfig', '风控', 12, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (152, '', 'Transaction/editAddConfig', '编辑风控提交', 12, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (153, '', 'Statistics/productChannelFinance', '支付通道统计', 42, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (154, '', 'Statistics/channelAccountFinance', '子账户统计', 42, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (155, 'fa fa-hand-rock-o', 'Order/handOrder', '补单记录', 22, 1, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (157, '', 'Withdrawal/uploadImg', '上传收款凭证', 29, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (158, 'fa fa-area-chart', 'Statistics/conCurrency', '并发量报表', 38, 1, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (159, 'fa fa-area-chart', 'Statistics/successRate', '成功率报表', 38, 1, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (160, 'fa fa-area-chart', 'Alipay/cashSweep', '支付宝资金归集', 31, 1, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (161, '', 'Alipay/editAccount', '编辑账号', 160, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (162, '', 'Alipay/delAccount', '删除账号', 160, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (163, '', 'Alipay/editStatus', '切换状态', 160, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (164, '', 'Alipay/getSweepAccount', '获取子账号的归集账号', 160, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (165, '', 'Alipay/saveSweepAccount', '保存子账号的归集账号', 160, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (166, '', 'Alipay/dispense', '下发', 160, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (167, '', 'Alipay/sweepList', '支付宝归集流水', 160, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (168, '', 'Alipay/getAccount', '获取子账号', 160, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (169, '', 'Alipay/dispenseDetail', '下发流水', 160, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (170, '', 'Alipay/sweepExportorder', '导出归集流水', 160, 0, 0, 1, 1, '', 0);
INSERT INTO `pay_auth_rule` VALUES (171, '', 'Alipay/dispenseExportorder', '导出下发流水', 160, 0, 0, 1, 1, '', 0);
...
CREATE TABLE `pay_auto_df_log`  (
  ...
  `msg` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '描述',
  `ctime` int(11) NOT NULL DEFAULT 0 COMMENT '提交时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '自动代付日志' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_auto_unfrozen_order`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_unfreezeing`(`status`, `is_pause`, `unfreeze_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投诉保证金余额' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_bankcard`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `userid` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商户编号',
  `bankname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '银行名称',
  `subbranch` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '支行名称',
  `accountname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '开户名',
  `cardnumber` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '银行卡号',
  `province_code` int(10) NOT NULL DEFAULT 0 COMMENT '省份代码',
  `province` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '所属省',
  `city_code` int(10) NOT NULL DEFAULT 0 COMMENT '城市代码',
  `city` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '所属市',
  `ip` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上次修改IP',
  `ipaddress` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'IP地址',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '备注',
  `isdefault` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否默认 1是 0 否',
  `updatetime` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `IND_UID`(`userid`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 479 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '银行卡表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_blockedlog`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `orderid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单号',
  `userid` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商户编号',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资金冻结待解冻记录' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_browserecord`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 107 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章浏览记录表' ROW_FORMAT = Fixed;

-- ----------------------------
-- Table structure for pay_cash_sweep
-- ----------------------------
DROP TABLE IF EXISTS `pay_cash_sweep`;
CREATE TABLE `pay_cash_sweep`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `username` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '支付宝账号',
  `realname` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '真实姓名',
  `addtime` int(10) NOT NULL DEFAULT 0 COMMENT '添加时间',
  `account_balance` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '账户资金',
  `day_sweep` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '日归集金额（第二天要清零，计划任务）',
  `accumulative_sweep` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '累计归集的金额',
  `withdraw_cash` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '已经提现出来金额',
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '状态 1开启 0关闭',
  `toplimit` decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '归集的资金上限',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `username`(`username`) USING BTREE,
  INDEX `addtime`(`addtime`) USING BTREE,
  INDEX `status`(`status`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '支付宝归集表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for pay_cash_sweep_detail
-- ----------------------------
DROP TABLE IF EXISTS `pay_cash_sweep_detail`;
CREATE TABLE `pay_cash_sweep_detail`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `pay_orderid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '四方系统订单号',
  `sweep_account` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '要归集到哪个支付宝账号',
  `channel_id` int(10) NOT NULL DEFAULT 0 COMMENT '入金渠道id',
  `channel_account_id` int(10) NOT NULL COMMENT '入金渠道子账号',
  `addtime` int(10) NOT NULL DEFAULT 0 COMMENT '添加时间',
  `amount` decimal(10, 2) NOT NULL COMMENT '金额',
  `status` tinyint(1) NOT NULL COMMENT '归集状态 0失败1成功',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '备注(支付宝错误码)',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `sweep_account`(`sweep_account`) USING BTREE,
  INDEX `addtime`(`addtime`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 72 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '支付宝资金归集明细表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章栏目' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_channel`  (
  ...
  `code` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '供应商通道英文编码',
  `title` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '供应商通道名称',
  `mch_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商户号',
  `signkey` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '签文密钥',
  `appid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '应用APPID',
  `appsecret` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '安全密钥',
  `gateway` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '网关地址',
  `pagereturn` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '页面跳转网址',
  `serverreturn` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '服务器通知网址',
  ...
  `unlockdomain` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '防封域名',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态 1开启 0关闭',
  ...
  `payment_product_id` smallint(4) NOT NULL DEFAULT 0 COMMENT '属于哪种支付产品（关联payment_product的主键id）',
  `product_id` smallint(4) NOT NULL DEFAULT 0 COMMENT '通道编码id(product表主键id)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 292 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '供应商列表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pay_channel
-- ----------------------------
INSERT INTO `pay_channel` VALUES (199, 'WxSm', '微信扫码支付', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0200, 1545800080, '', 0, 1, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (200, 'WxGzh', '微信H5', '', '', 'wxf33668d58442ff6e', '', '', '', '', 0.0000, 0.0000, 0.0000, 1502378687, '', 0, 2, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (201, 'Aliscan', '支付宝扫码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0160, 1545800112, '', 0, 4, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (202, 'Aliwap', '支付宝H5', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0160, 1545799549, '', 0, 4, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (203, 'QQSCAN', 'QQ扫码', '', '', '', '', '', '', '', 0.0050, 0.0000, 0.0000, 1503280494, '', 0, 8, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (204, 'GCNYalipay', 'GCNY-支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0180, 1546814934, '', 0, 3, 0, 0, 0.00, 0.00, 0, 10.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (205, 'GCNYwxpay', 'GCNY-微信', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0200, 1545800242, '', 0, 1, 0, 0, 0.00, 0.00, 0, 10.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (206, 'WMpay', '万码-支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0180, 1546814951, '', 0, 3, 0, 0, 19989.76, 0.00, 1544348336, 0.00, 0.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (207, 'WMwxpay', '万码-微信', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0200, 1545800047, '', 0, 1, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (208, 'AnYinalipay', '安联支付宝WAP', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0160, 1545800150, '', 0, 4, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (209, 'QiFenQianpay', '七分钱', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0160, 1545800125, '', 0, 4, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (211, 'WMalipayTransfer', '支付宝转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0150, 1545800028, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (213, 'Alidmpay', '当面付', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0160, 1545799816, '', 1, 4, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (214, 'JiuFu', '玖付-口碑', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0180, 1545723936, '', 0, 4, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (215, 'ImmediatelyPayScanGR', '马上付-个人扫码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0040, 1546150816, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (216, 'ImmediatelyPayScanQY', '马上付-企业扫码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0040, 1546150812, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (217, 'ImmediatelyPayWAPQY', '马上付-企业WAP', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0040, 1546150808, '', 0, 4, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (218, 'ImmediatelyPayWAPGR', '马上付-个人WAP', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0040, 1546150803, '', 0, 4, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (220, 'WMalipayTransferHGW', 'HGW转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0140, 1546324507, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (221, 'WMalipayWS', '万码-自定义码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1546418290, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (222, 'WMpayHGW', 'HGW固码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0140, 1546852873, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (223, 'OnlineBankingTransfer', '网银转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1546946022, '', 1, 5, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (224, 'WMpaySJB', 'AR支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0130, 1546853219, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (225, 'WMpayYAN', 'YAN支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0130, 1547021209, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (226, 'PolymerizationPay', '钱到啦', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1547207596, '', 0, 12, 0, 0, 0.00, 0.00, 0, 100.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (227, 'WMpayKai', 'Kai支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0130, 1547219961, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (228, 'WMpayZQR', 'ZQR支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0130, 1548758679, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (232, 'UnionPayWS', '云闪付', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1547628118, '', 0, 13, 0, 0, 0.00, 0.00, 0, 100.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (233, 'AlipayPersionPay', '支付宝个码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0150, 1547721686, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (234, 'BankTransferPay', '银行卡转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0150, 1547721679, '', 1, 3, 0, 0, 0.00, 0.00, 0, 200.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (235, 'GCNYSquareAlipayScan', 'G宝四方支付宝扫码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0150, 1548241435, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (236, 'DpayWechatScan', 'D付微信扫码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1547795395, '', 1, 1, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (237, 'DpayWechatH5', 'D付微信H5', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1547789232, '', 1, 2, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (238, 'YanBankTransferPay', 'YAN银行卡转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1548005014, '', 0, 3, 0, 0, 0.00, 0.00, 0, 200.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (239, 'ARBankTransferPay', 'AR银行卡转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1548095400, '', 0, 3, 0, 0, 0.00, 0.00, 0, 200.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (240, 'KaiBankTransferPay', 'Kai银行卡转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1548161193, '', 1, 3, 0, 0, 0.00, 0.00, 0, 200.00, 5000.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (241, 'ZQRBankTransferPay', 'ZQR银行卡转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0130, 1548754638, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (242, 'AutoTransferAliPay', '支付宝自定义转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0180, 1548485093, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (243, 'WXLBankTransferPay', 'WXL银行卡转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1548423248, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (244, 'HTBankTransferPay', 'HT银行卡转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0130, 1548745916, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (245, 'XJZBankTransferPay', 'XJZ银行卡转账', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1548427042, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (246, 'WMpayHT', 'HT支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0130, 1548759584, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (247, 'WXLGuMaPay', 'WXL支付宝固码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1548814270, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (248, 'ARGuMaPay', 'AR支付宝固码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1548814549, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (249, 'HTGuMaPay', 'HT支付宝固码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1548814725, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (250, 'XJZGuMaPay', 'XJZ固码支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1548815076, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (251, 'CMGuMaPay', 'CM固码支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1548817308, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (252, 'HNGuMaPay', 'HN固码支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1548817353, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (253, 'QHDGuMaPay', 'QHD固码支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1548817990, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (254, 'TZGuMaPay', 'TZ固码支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1548818017, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (255, 'AutoPersionPay', '自定义个码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1548953472, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (256, 'WMpayYAN', 'YAN支付宝大额', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0130, 1549437518, '', 0, 3, 0, 0, 0.00, 0.00, 0, 1000.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (257, 'AliRedBagPay', '支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1550055539, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (258, 'YanAliRedBagPay', 'YAN支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1550055571, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (259, 'KaiAliRedBagPay', 'Kai支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0100, 1550055522, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (260, 'HTAliRedBagPay', 'HT支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1550055512, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (261, 'XJZAliRedBagPay', 'XJZ支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1550138082, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (262, 'ArAliRedBagPay', 'AR支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1551406735, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (263, 'WxlAliRedBagPay', 'Wxl支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1550130029, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (264, 'QhdAliRedBagPay', 'Qhd支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1550130070, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (265, 'YU001RedBagPay', 'YU001支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1550544473, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (266, 'YU002RedBagPay', 'YU002支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1550544454, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (267, 'YU003RedBagPay', 'YU003支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1550544445, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (268, 'YU001AutoPersionPay', 'YU001自定义个码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1550834689, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (269, 'YU002AutoPersionPay', 'YU002自定义个码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1550834683, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (270, 'YU003AutoPersionPay', 'YU003自定义个码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1550834843, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (271, 'KaiAutoPersionPay', 'Kai自定义个码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1550835485, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (272, 'HTAutoPersionPay', 'HT自定义个码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1550834830, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (273, 'AllInPay', '通联收银宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0280, 1551079796, '', 1, 1, 0, 0, 0.00, 200000.00, 1551101169, 0.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (274, 'ZxWechatPay', '全付通--微信', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0280, 1550995097, '', 1, 1, 0, 0, 300.20, 200000.00, 1551083066, 0.00, 1000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (275, 'ZxAlipay', '全付通-支付宝', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0200, 1551012927, '', 1, 3, 0, 0, 1200.10, 200000.00, 1551016501, 100.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (276, 'CompanyAlidmpay', '支付宝企业当面付', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0200, 1551153778, '', 1, 4, 0, 0, 0.00, 0.00, 0, 10.00, 5000.00, 1, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (277, 'KaiAliFriendPay', 'Kai好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1551281477, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (278, 'Yu001AliFriendPay', 'Yu001好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1551281511, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (279, 'Yu002AliFriendPay', 'Yu002好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1551281927, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (280, 'Yu003AliFriendPay', 'Yu003好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1551282152, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (281, 'HTAliFriendPay', 'HT好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1551282279, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (282, 'YanAliFriendPay', 'Yan好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1551282369, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (283, 'ArAliFriendPay', 'AR好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1551282501, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (284, 'XJZAliFriendPay', 'XJZ好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0090, 1551282706, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (285, 'ARCCBGumaPay', 'AR龙支付固码', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0180, 1551694407, '', 1, 1, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (286, 'GSAliFriendPay', 'GS好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1551783725, '', 1, 4, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (287, 'GSAliRedBagPay', 'GS支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1551752770, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (288, 'YMAliFriendPay', 'YM好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1551752795, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (289, 'YMAliRedBagPay', 'YM支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1551752812, '', 1, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (290, 'ZWZAliFriendPay', 'ZWZ好友收款', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1551752944, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
INSERT INTO `pay_channel` VALUES (291, 'ZWZAliRedBagPay', 'ZWZ支付宝红包', '', '', '', '', '', '', '', 0.0000, 0.0000, 0.0000, 1551752963, '', 0, 3, 0, 0, 0.00, 0.00, 0, 0.00, 0.00, 0, 1, 0.0000, 0.0000, 0.0000, 0, 0);
...
CREATE TABLE `pay_channel_account`  (
  ...
  `signkey` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '签文密钥',
  `appid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '应用APPID',
  `appsecret` varchar(2500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '安全密钥',
  `defaultrate` decimal(10, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '下家费率',
  `fengding` decimal(10, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '封顶手续费',
  `rate` decimal(10, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '银行费率',
  `updatetime` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '上次更改时间',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态 1开启 0关闭',
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '账户标题',
  `weight` tinyint(2) NULL DEFAULT NULL COMMENT '轮询权重',
  `custom_rate` tinyint(1) NULL DEFAULT NULL COMMENT '是否自定义费率',
  ...
  `time_unit` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 's' COMMENT '限制时间单位',
  ...
  `t0fengding` decimal(10, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT 'T0封顶手续费',
  `t0rate` decimal(10, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT 'T0成本费率',
  `unlockdomain` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '防封域名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1122 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '供应商账号列表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for pay_channel_account_cash_sweep
-- ----------------------------
DROP TABLE IF EXISTS `pay_channel_account_cash_sweep`;
CREATE TABLE `pay_channel_account_cash_sweep`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `channel_id` int(10) NOT NULL COMMENT '商户id',
  `channel_account_id` int(10) NULL DEFAULT NULL,
  `cash_sweep_ids` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '资金归集的支付宝账号，多个用逗号隔开，对应cash_sweep的主键id',
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '状态 0关1开',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `userid`(`channel_id`) USING BTREE
...
CREATE TABLE `pay_complaints_deposit`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户ID',
  `pay_orderid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '系统订单号',
  `out_trade_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '下游订单号',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_unfreezeing`(`status`, `is_pause`, `unfreeze_time`) USING BTREE,
  INDEX `pay_orderid`(`pay_orderid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投诉保证金余额' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_complaints_deposit_rule`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投诉保证金规则表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_df_api_order`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `userid` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商户编号',
  `trade_no` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '平台订单号',
  `out_trade_no` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '商户订单号',
  `money` decimal(15, 4) NOT NULL DEFAULT 0.0000 COMMENT '金额',
  `bankname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '银行名称',
  `subbranch` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '支行名称',
  `accountname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '开户名',
  `cardnumber` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '银行卡号',
  `province` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '所属省',
  `city` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '所属市',
  `ip` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT 'IP地址',
  `check_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0：待审核 1：已提交后台审核 2：审核驳回',
  `extends` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '扩展字段',
  `df_id` int(11) NOT NULL DEFAULT 0 COMMENT '代付ID',
  `notifyurl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '异步通知地址',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `IND_UID`(`userid`) USING BTREE,
  INDEX `df_id`(`df_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 479 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商户代付申请管理（通过API提交）' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_email`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `smtp_host` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '服务器地址',
  `smtp_port` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '端口',
  `smtp_user` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户名',
  `smtp_pass` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '密码',
  `smtp_email` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发件人邮箱',
  `smtp_name` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发件人姓名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '邮箱设置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_invitecode`  (
  ...
  `fmusernameid` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '发布者',
  `syusernameid` int(11) NOT NULL DEFAULT 0 COMMENT '使用者',
  `regtype` tinyint(1) UNSIGNED NOT NULL DEFAULT 4 COMMENT '用户组 4 普通用户 5 代理商',
  `fbdatetime` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '生成时间',
  `yxdatetime` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '过期时间',
  `sydatetime` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '使用时间',
...
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '邀请码表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_inviteconfig`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `invitezt` tinyint(1) UNSIGNED NULL DEFAULT 1,
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '邀请码配置' ROW_FORMAT = Fixed;
...
CREATE TABLE `pay_loginrecord`  (
  ...
  `logindatetime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '登录时间戳',
  `loginip` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '登录ip',
  `loginaddress` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登录地点',
  `type` tinyint(1) NOT NULL DEFAULT 0 COMMENT '类型：0：前台用户 1：后台用户',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 13931 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_member`  (
  ...
  `salt` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '密码随机字符',
  ...
  `activate` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `sfznumber` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '身份证号',
  ...
  `paypassword` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付密码',
  `authorized` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '1 已认证 0 未认证 2 待审核',
  `apidomain` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '授权访问域名',
  `apikey` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'APIKEY',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态 1激活 0未激活',
  `receiver` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '台卡显示的收款人信息',
  `unit_paying_number` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '单位时间已交易次数',
  `unit_paying_amount` decimal(15, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '单位时间已交易金额',
  ...
  `df_domain` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '代付域名报备',
  `df_auto_check` tinyint(1) NOT NULL DEFAULT 0 COMMENT '代付API自动审核',
  `google_secret_key` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '谷歌密钥',
  `df_ip` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '代付域名报备IP',
  `session_random` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'session随机字符串',
  `df_charge_type` tinyint(1) NOT NULL DEFAULT 0 COMMENT '代付API扣除手续费方式，0：从到账金额里扣，1：从商户余额里扣',
  `last_login_time` int(11) NOT NULL DEFAULT 0 COMMENT '最后登录时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 150 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_member_agent_cate`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `cate_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '等级名',
  `desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '等级描述',
  `ctime` int(11) NULL DEFAULT 0 COMMENT '添加时间',
  `sort` int(11) NULL DEFAULT 99 COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商户（代理商）等级表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_moneychange`  (
  ...
  `datetime` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `transid` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交易流水号',
  `tongdao` smallint(6) UNSIGNED NULL DEFAULT 0 COMMENT '支付通道ID',
  `lx` tinyint(3) UNSIGNED NOT NULL DEFAULT 1 COMMENT '类型',
  `tcuserid` int(11) NULL DEFAULT NULL COMMENT '用户名(提成)',
  `tcdengji` int(11) NULL DEFAULT NULL COMMENT '提成级别',
  `orderid` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订单号',
  `contentstr` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `t` int(4) NOT NULL DEFAULT 0 COMMENT '结算方式',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 577890 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资金变动记录(佣金记录)' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_order`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `pay_memberid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商户编号',
  `pay_orderid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '系统订单号',
  `pay_amount` decimal(15, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '付款金额',
  `pay_poundage` decimal(15, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '手续费',
  `pay_actualamount` decimal(15, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '付款金额减去手续费',
  ...
  `pay_bankcode` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '银行编码(对应product表的主键id)',
  `pay_notifyurl` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商家异步通知地址',
  `pay_callbackurl` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商家页面通知地址',
  `pay_bankname` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付银行',
  `pay_status` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单状态: 0 未支付 1 已支付未返回 2 已支付已返回',
  `pay_productname` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品名称',
  `pay_tongdao` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付通道',
  `pay_zh_tongdao` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付通道',
  `pay_tjurl` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `out_trade_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商户订单号',
  `num` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '已补发次数',
  `memberid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付渠道商家号',
  `key` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付渠道密钥',
  `account` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '渠道账号',
  `isdel` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '伪删除订单 1 删除 0 未删',
  `ddlx` int(11) NULL DEFAULT 0,
  `pay_ytongdao` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `pay_yzh_tongdao` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `xx` smallint(6) UNSIGNED NOT NULL DEFAULT 0,
  `attach` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '商家附加字段,原样返回',
  `pay_channel_account` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '通道账户',
  ...
  `channel_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '渠道(供应商)id(对应channel表的主键id)',
  `t` tinyint(2) NOT NULL DEFAULT 1 COMMENT '结算周期（计算费率）',
  `last_reissue_time` int(11) NOT NULL DEFAULT 11 COMMENT '最后补发时间',
  `lock_status` tinyint(1) NULL DEFAULT 0 COMMENT '是否冻结订单，1冻结，2解冻',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '补单备注',
  `remark_time` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '补单时间',
  `remark_tube` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '补单通道',
  `remark_bank` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '补单银行',
  `isReset` tinyint(1) UNSIGNED NULL DEFAULT 1 COMMENT '是否重复扫码1否2是',
  `bank_id` int(11) NULL DEFAULT NULL COMMENT '银行id',
  `alipay_param` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '支付宝回调参数',
  `sweep_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '支付宝资金归集状态',
  `sweep_num` tinyint(1) NULL DEFAULT 0 COMMENT '归集的次数',
  `remark_account` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '备注子账号',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `IND_ORD`(`pay_orderid`) USING BTREE,
  INDEX `account_id`(`account_id`) USING BTREE,
  INDEX `channel_id`(`channel_id`) USING BTREE,
  INDEX `out_trade_id`(`out_trade_id`) USING BTREE,
  INDEX `alipay_param`(`alipay_param`(255)) USING BTREE,
  INDEX `sweep_status`(`sweep_status`) USING BTREE,
  INDEX `sweep_num`(`sweep_num`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 500907 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_pay_channel_extend_fields`  (
  ...
  `code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '代付渠道代码',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '扩展字段名',
  `alias` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '扩展字段别名',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '备注',
  `etime` int(11) NOT NULL DEFAULT 0 COMMENT '修改时间',
  `ctime` int(11) NOT NULL DEFAULT 0 COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '支付通道扩展字段' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_pay_for_another`  (
  ...
  `code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '代付代码',
  `title` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '代付名称',
  `mch_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '商户号',
  `appid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '应用APPID',
  `appsecret` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '应用密钥',
  `signkey` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '加密的秘钥',
  `public_key` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '加密的公钥',
  `private_key` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '加密的私钥',
  `exec_gateway` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '请求代付的地址',
  `query_gateway` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '查询代付的地址',
  `serverreturn` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '服务器通知网址',
  `unlockdomain` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '防封域名',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代付通道表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_paylog`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `out_trade_no` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '交易号',
  `result_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '结果码',
  `transaction_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '流水',
  `fromuser` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名',
  `time_end` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '结束时间',
  `total_fee` smallint(6) UNSIGNED NOT NULL DEFAULT 0 COMMENT '总费用',
  `payname` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '支付名',
  `bank_type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '银行类型',
  `trade_type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交易类型',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `IND_TRD`(`transaction_id`) USING BTREE,
  UNIQUE INDEX `IND_ORD`(`out_trade_no`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '支付日志' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for pay_payment_product
-- ----------------------------
DROP TABLE IF EXISTS `pay_payment_product`;
CREATE TABLE `pay_payment_product`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '名称',
  `pid` mediumint(8) NOT NULL DEFAULT 0 COMMENT '通道编码（product主键id）',
  `num` int(10) NOT NULL DEFAULT 0 COMMENT '该支付产品下游几条入金渠道',
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '状态 0关闭1开启',
  `addtime` int(10) NOT NULL,
  `updatetime` int(10) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '支付产品，用于归类入金渠道' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_product`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '通道名称',
  `code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '通道代码',
  ...
  `weight` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '平台默认通道权重',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 914 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '支付(产品)通道' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pay_product
-- ----------------------------
INSERT INTO `pay_product` VALUES (901, '微信公众号', 'WXJSAPI', 0, 2, 1, 1, 0, '', 0.0000, 0.0000, 0.0000, 0.0000);
INSERT INTO `pay_product` VALUES (902, '微信扫码支付', 'WXSCAN', 0, 1, 1, 1, 274, '', 0.0000, 0.0000, 0.0000, 0.0000);
INSERT INTO `pay_product` VALUES (903, '支付宝扫码支付', 'ALISCAN', 1, 3, 1, 1, 206, '206:5|211:4', 0.0000, 0.0000, 0.0000, 0.0000);
INSERT INTO `pay_product` VALUES (904, '支付宝手机', 'ALIWAP', 0, 4, 1, 1, 214, '', 0.0000, 0.0000, 0.0000, 0.0000);
...
INSERT INTO `pay_product` VALUES (911, '支付宝WAP', 'AliNative', 0, 4, 0, 0, 0, '', 0.0000, 0.0000, 0.0000, 0.0000);
INSERT INTO `pay_product` VALUES (912, '快捷支付', 'Fast', 0, 12, 1, 1, 0, '', 0.0000, 0.0000, 0.0000, 0.0000);
INSERT INTO `pay_product` VALUES (913, '银联扫码', 'BANKSCAN', 0, 13, 1, 1, 0, '', 0.0000, 0.0000, 0.0000, 0.0000);
...
CREATE TABLE `pay_product_user`  (
  ...
  `weight` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '通道权重',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `pid`(`pid`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 928 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_reconciliation`  (
  ...
  `order_total_count` int(11) NULL DEFAULT 0 COMMENT '总订单数',
  `order_success_count` int(11) NULL DEFAULT 0 COMMENT '成功订单数',
  `order_fail_count` int(11) NULL DEFAULT 0 COMMENT '未支付订单数',
  `order_total_amount` decimal(11, 4) NULL DEFAULT 0.0000 COMMENT '订单总额',
  `order_success_amount` decimal(11, 4) NULL DEFAULT 0.0000 COMMENT '订单实付总额',
...
CREATE TABLE `pay_redo_order`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '冲正备注',
  `date` datetime(0) NOT NULL COMMENT '冲正周期',
  `ctime` int(11) NOT NULL DEFAULT 0 COMMENT '操作时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '冲正订单' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_route`  (
  ...
  `urlstr` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `pay_sms`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `app_key` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'App Key',
  `app_secret` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'App Secret',
  `sign_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '默认签名',
  `is_open` int(11) NULL DEFAULT 0 COMMENT '是否开启，0关闭，1开启',
  `admin_mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '管理员接收手机',
  `is_receive` int(11) NULL DEFAULT 0 COMMENT '是否开启，0关闭，1开启',
  `sms_channel` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'aliyun' COMMENT '短信通道',
  `smsbao_user` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '短信宝账号',
  `smsbao_pass` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '短信宝密码',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '短信设置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_sms_template`  (
  ...
  `template_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '模板代码',
  `call_index` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '调用字符串',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '短信模板表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_systembank`  (
  ...
  `bankname` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `images` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 198 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '结算银行' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_template`  (
  ...
  `theme` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '模板代码',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '模板表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_tikuanconfig`  (
  ...
  `sxfrate` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单笔提款比例',
  `sxffixed` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单笔提款手续费',
  `issystem` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '平台规则 1 是 0 否',
  ...
  `auto_df_stime` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '自动代付开始时间',
  `auto_df_etime` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '自动代付结束时间',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `IND_UID`(`userid`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '提款设置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_tikuanholiday`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '排除节假日' ROW_FORMAT = Fixed;
...
CREATE TABLE `pay_tikuanmoney`  (
  ...
  `datetype` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `createtime` int(11) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 691 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `pay_tikuantime`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `baiks` tinyint(2) UNSIGNED NULL DEFAULT 0 COMMENT '白天提款开始时间',
  `baijs` tinyint(2) UNSIGNED NULL DEFAULT 0 COMMENT '白天提款结束时间',
  `wanks` tinyint(2) UNSIGNED NULL DEFAULT 0 COMMENT '晚间提款开始时间',
  `wanjs` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '提款时间' ROW_FORMAT = Fixed;
...
CREATE TABLE `pay_tklist`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `userid` int(11) NOT NULL,
  `bankname` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '银行名称',
  `bankzhiname` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '支行名称',
  `banknumber` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '银行卡号',
  `bankfullname` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '开户名',
  `sheng` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '省',
  `shi` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '市',
  `sqdatetime` datetime(0) NULL DEFAULT NULL COMMENT '申请时间',
  `cldatetime` datetime(0) NULL DEFAULT NULL COMMENT '处理时间',
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '状态',
  `tkmoney` decimal(15, 4) NOT NULL DEFAULT 0.0000 COMMENT '结算金额<',
  `sxfmoney` decimal(15, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '手续费',
  `money` decimal(15, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '到账金额',
  `t` int(4) NOT NULL DEFAULT 1 COMMENT '类型',
  `payapiid` int(11) NOT NULL DEFAULT 0,
  `memo` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '备注',
  `tk_charge_type` tinyint(1) NOT NULL DEFAULT 0 COMMENT '扣除手续费方式，0：从到账金额里扣，1：从商户余额里扣',
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上传凭证',
  `upload_time` int(11) NULL DEFAULT NULL COMMENT '上传凭证时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6462 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '提款表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_updatelog`  (
  ...
  `lastupdate` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
...
CREATE TABLE `pay_user_channel_account`  (
  ...
  `account_ids` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '子账号id',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否开启指定账号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `userid`(`userid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 85 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户指定指账号' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for pay_user_channel_control
-- ----------------------------
DROP TABLE IF EXISTS `pay_user_channel_control`;
CREATE TABLE `pay_user_channel_control`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `userid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户id',
  `channel_ids` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '通道id',
  `type` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '轮询控制类型',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `userid`(`userid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 462 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '轮询控制' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_user_code`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `type` int(11) NULL DEFAULT 0 COMMENT '0找回密码',
  ...
  `endtime` int(11) NULL DEFAULT NULL COMMENT '有效时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `pay_user_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 110538 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户操作日志表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for pay_user_payment_product_rate
-- ----------------------------
DROP TABLE IF EXISTS `pay_user_payment_product_rate`;
CREATE TABLE `pay_user_payment_product_rate`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `userid` int(10) NOT NULL DEFAULT 0 COMMENT '通道id',
  `payment_product_id` int(10) NOT NULL,
  `rate` decimal(10, 4) NOT NULL DEFAULT 0.0000 COMMENT '费率',
  `addtime` int(10) NOT NULL,
  `updatetime` int(10) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `payment_product_id`(`payment_product_id`) USING BTREE,
  INDEX `userid`(`userid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户支付产品费率表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_user_riskcontrol_config`  (
  ...
  `time_unit` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'i' COMMENT '限制的时间单位',
  `unit_interval` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '单位时间值',
  `domain` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT ' ' COMMENT '防封域名',
  `systemxz` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0 系统规则 1 用户规则',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uid`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '交易配置' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_userrate`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 768 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商户通道费率' ROW_FORMAT = Fixed;
...
CREATE TABLE `pay_version`  (
  ...
  `save_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0000-00-00' COMMENT '修改时间,格式YYYY-mm-dd',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据库版本表' ROW_FORMAT = Compact;
...
CREATE TABLE `pay_websiteconfig`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `websitename` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '网站名称',
  `domain` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '网址',
  ...
  `directory` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '后台目录名称',
  `icp` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `tongji` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '统计',
  `login` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登录地址',
  `payingservice` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '商户代付 1 开启 0 关闭',
  ...
  `serverkey` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '授权服务key',
  `withdraw` tinyint(1) NULL DEFAULT 0 COMMENT '提现通知：0关闭，1开启',
  `login_warning_num` tinyint(3) UNSIGNED NOT NULL DEFAULT 3 COMMENT '前台可以错误登录次数',
  `login_ip` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '登录IP',
  `is_repeat_order` tinyint(3) UNSIGNED NOT NULL DEFAULT 1 COMMENT '是否允许重复订单:1是，0否',
  `google_auth` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否开启谷歌身份验证登录',
  `df_api` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否开启代付API',
  `logo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '公司logo',
  ...
  `document_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '对接文档链接',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '网站基本配置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pay_websiteconfig
-- ----------------------------
INSERT INTO `pay_websiteconfig` VALUES (1, '万码支付系统', 'rain.haohan168.cn:8086', '66666@pay.com', '4001234456', '', 'manage', '沪ICP备8888888号', '', 'pay9', 0, 1, 0, '万码支付', '0d6de302cbc615de3b09463acea87662', 1, 3, ' ', 0, 0, 1, 'Uploads/logo/5c072afc0ac4d.png', 0, 1, 0, 5, 10, '');
...
CREATE TABLE `pay_wttklist`  (
  ...
  `payapiid` int(11) NOT NULL DEFAULT 0,
  `memo` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '备注',
  `additional` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '额外的参数',
  `code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '代码控制器名称',
  `df_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '代付通道id',
  `df_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '代付名称',
  `orderid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT ' ' COMMENT '订单id',
  `cost` decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '成本',
  `cost_rate` decimal(10, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '成本费率',
  `rate_type` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '费率类型：按单笔收费0，按比例收费：1',
  `extends` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '扩展数据',
  `out_trade_no` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '下游订单号',
  `df_api_id` int(11) NULL DEFAULT 0 COMMENT '代付API申请ID',
  ...
  `channel_mch_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '通道商户号',
  `df_charge_type` tinyint(1) NOT NULL DEFAULT 0 COMMENT '代付API扣除手续费方式，0：从到账金额里扣，1：从商户余额里扣',
  `transaction_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '上游订单号',
  `billno` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '上游交易流水号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `code`(`code`) USING BTREE,
  INDEX `df_id`(`df_id`) USING BTREE,
  INDEX `orderid`(`orderid`) USING BTREE,
  INDEX `df_api_id`(`df_api_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 465 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代付记录表' ROW_FORMAT = Compact;
